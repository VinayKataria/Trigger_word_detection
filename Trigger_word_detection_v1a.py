...
def insert_ones(y, segment_end_ms):
    ...
    50 following labels should be ones.
         ...
         Update the label vector y. Strictly speaking, the label of the 50 output steps after the end of the segment should be set to 1. Strictly speaking,
         What we mean is that the label of segment_end_y should be 0, and the following 50 labels should be 1. ?????
